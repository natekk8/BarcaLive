...
function renderTransmissions(channels) {
    ...
    if (!channels || channels.length === 0) {
        container.innerHTML = `
            <div class="col-span-full flex flex-col items-center justify-center w-full h-full min-h-[220px] text-center">
                ...
                <span class="text-xs font-black uppercase tracking-widest px-4 text-white">Brak informacji o transmisji</span>
            </div>`;
        return;
    }
